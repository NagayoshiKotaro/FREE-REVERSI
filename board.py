...
figpath = pjoin(os.getcwd(),"figure")

class piece():
    def __init__(self,x,y,c):
        if c > 0:
            filename = pjoin(figpath,"black.png")
        elif c < 0:
            filename = pjoin(figpath,"white.png")
...
class board():
    def __init__(self,x,y):
        filename = pjoin(figpath,"board.png")
        music_path = pjoin(os.getcwd(),"music")
        self.sprite = MySprite(x,y,filename)
        self.bd = [piece(x+217,y+220,1),piece(x+217,y+280,-1),piece(x+280,y+220,-1),piece(x+280,y+280,1)]
        self.num = 4
        self.maxNum = 54
        #距離の閾値
        self.r_thre = 100
        #色と色との線
        self.lines = None
        self.put_se = pygame.mixer.Sound(pjoin(music_path,"put_piece.ogg"))
